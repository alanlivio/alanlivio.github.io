...
The next figures present Academic training certificates in topics of Research Supervising, Personal Tutoring, Data protection, People Management, Diversity, Research Funding, and Digital Humanities.
...
\begin{figure}
    \centering
    \includegraphics[align=t,width=\textwidth,height=0.3\paperheight, keepaspectratio=true]{certificates/uor-training/AFHEA.pdf}
    \includegraphics[align=t,width=\textwidth,height=0.3\paperheight, keepaspectratio=true]{certificates/uor-training/FHEA.pdf}
    \includegraphics[align=t,width=\textwidth,height=0.3\paperheight, keepaspectratio=true]{certificates/uor-training/digital-humanities.pdf}
\end{figure}
