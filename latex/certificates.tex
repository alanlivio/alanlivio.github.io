...
\begin{figure}
    \centering
    \includegraphics[align=t,width=\textwidth, keepaspectratio=true]{certificates/bsc-certificate.pdf}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[align=t,width=\textwidth, keepaspectratio=true]{certificates/msc-certificate.pdf}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[align=t,width=\textwidth,height=0.75\textheight, keepaspectratio=true, trim={6cm 0 3cm 0},clip]{certificates/phd-certificate.pdf}
\end{figure}
