...
\begin{figure}
    \centering
    \includegraphics[align=t,width=\textwidth, keepaspectratio=true]{certificates/M.Sc.-diploma.pdf}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[align=t,width=\textwidth,height=0.75\textheight, keepaspectratio=true, trim=0cm 0cm 0cm 2cm]{certificates/M.Sc.-grades.pdf}
\end{figure}
...
\begin{figure}
    \centering
    \includegraphics[align=t,width=\textwidth,height=0.75\textheight, keepaspectratio=true, page=2, trim=0cm 0cm 0cm 2cm]{certificates/M.Sc.-grades.pdf}
\end{figure}
