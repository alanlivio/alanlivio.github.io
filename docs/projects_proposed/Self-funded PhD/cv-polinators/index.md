...
Our primary goals are to: 1) Developing comprehensive, well-annotated **datasets of insect behavior**, trajectories, and flower interactions, enhanced through data augmentation; 2) designing detection computer vision models with a focus on minimizing computational demands, making them suitable for deployment in energy- and resource-constrained environments; and 3) **group behavioral understanding** analyze both pollinator behavior and land usage, emphasizing trajectory analysis to interaction patterns.  
