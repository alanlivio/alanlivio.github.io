---
title: GenAI chatbot using cloud-based multi-agents and RAG
type: projects/ug
image: https://miro.medium.com/v2/resize:fit:1200/1*cf-F49DeJJFyX6aoNjRcyg.png
---

# GenAI chatbot with multi-agents and RAG using Amazon Bedrock

<div style="text-align: center">
  <img src="https://miro.medium.com/v2/resize:fit:1200/1*cf-F49DeJJFyX6aoNjRcyg.png" width="300" lightbox="true" />
</div>
